...
<!-- Mirrored from davis-html.netlify.app/index2 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Aug 2024 12:14:02 GMT -->
  ...
  <section class="st-hero st-style2">
    <div class="container">
      <div class="st-hero-text">
        <h1>Hi, I am <span>Abdul Rasheed</span></h1>
        <p>Full Stack Developer || WordPress Designer || FrontEnd Developer || <br> PHP developer || Laravel Developer </p>
        <div class="st-hero-social-links">
         
          <a target = "_blank" href="https://www.linkedin.com/in/abdulrasheedd/" class="st-social-btn">
            <i class="fab fa-linkedin"></i>
          </a>
          <!-- <a target = "_blank" href="https://github.com/AbdulRasheed19" class="st-social-btn">
      ...
      <div class="row">
        <div class="col-lg-6 wow fadeInLeft">
          <div class="st-about-img-wrap">
            <div class="st-about-img st-dynamic-bg st-bg" data-src="assets/img/section/arkp.jpg"></div>
          </div>
          ...
          <div class="st-vertical-middle">
            <div class="st-vertical-middle-in">
              <div class="st-text-block st-style1">
                <h2 class="st-text-block-title">Hi There! I'm Abdul Rasheed</h2>
                <h4 class="st-text-block-subtitle">Software Engineer || Full Stack Developer || WordPress Designer</h4>
                <div class="st-text-block-text">
                  <p>I’m a web developer with over 2+ years of experience building websites that are easy to use and look great. I work with Laravel, PHP, HTML, CSS, JavaScript, and WordPress to create websites that are fast and responsive.

I have experience with Avada, WPBakery, and Elementor for WordPress development, and I always deliver projects on time. I enjoy working in teams and keep up with the latest trends in web development</p>
                </div>
                <ul class="st-text-block-details st-mp0">
                  <li><span>Birthday</span> : <span>feb 06, 2000</span></li>
                  <li><span>Phone</span> : <span>+923131377118</span></li>
                   <li><span>Experience</span> : <span>2+ years</span></li>
                    <li><span>Degree</span> : <span>BE Software Engineering</span></li>
                  <li><span>Email</span> : <span>arkabdulrasheed19@gmail.com</span></li>
                  <li><span>City</span> : <span> Karachi, Pakistan</span></li>
                  <li><span>Language</span> : <span>English, Urdu, Sindhi ,Balochi</span></li>
                  <!-- <li><span>Freelance</span> : <span>Available</span></li> -->
                </ul>
                <div class="st-text-block-btn">
                <a href="assets/CV.pdf" class="st-btn st-style1 st-color1" download>Download CV</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-6">
          <div class="st-skill-wrap">
            <div class="st-skill-heading">
              <h2 class="st-skill-title">Expert Web Developer with 2+ Years of Experience</h2>
              <div class="st-skill-subtitle">I’m a web developer with over 2 years of experience in creating websites that are both functional and visually appealing. My expertise includes Laravel, PHP, HTML, CSS, JavaScript, Bootstrap, and WordPress, allowing me to build responsive and efficient websites.

<br><br>I also have experience working with Avada, WPBakery, and Elementor to develop dynamic WordPress sites. I’m dedicated to delivering high-quality projects on time, and I enjoy collaborating with teams to achieve the best results. I continuously stay updated with the latest web technologies and trends.
              </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="st-progressbar-wrap">
            ...
            <div class="st-single-progressbar">
              <div class="st-progressbar-heading">
                <h3 class="st-progressbar-title">CMS: WordPress (Avada, WPBakery, Elementor)</h3>
                <div class="st-progressbar-percentage wow fadeInLeft" data-wow-duration="1.5s"
                    data-wow-delay="0.5s">85%</div>
              </div>
            ...
            <div class="st-single-progressbar">
              <div class="st-progressbar-heading">
                <h3 class="st-progressbar-title">MySql</h3>
                <div class="st-progressbar-percentage wow fadeInLeft" data-wow-duration="1.5s"
                    data-wow-delay="0.5s">90%</div>
              </div>
              <div class="st-progressbar" data-progress="90">
        ...
        <div class="col-lg-6">
          <div class="st-resume-wrap">
            <div class="st-resume-heading">
              ...
              <h2 class="st-resume-heading-title">Professional Experience</h2>
            </div>
            ...
            <div class="st-resume-timeline-wrap">
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Full Stack Developer</h3>
                <div class="st-resume-timeline-duration">Current</div>
                <h4 class="st-resume-timeline-subtitle">TechiXpert</h4>
                <div class="st-resume-timeline-text">
                  <p>•	Design and develop web applications using modern technologies.<br>
•	Implement and maintain both front-end and back-end features in various projects.
</p>
                </div>
              </div> <!-- st-resume-timeline -->
              <div class="st-height-b50 st-height-lg-b30"></div>
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Web Developer Intern </h3>
                <div class="st-resume-timeline-duration"> (Remote) | Oct 2022 – Nov 2022</div>
                <h4 class="st-resume-timeline-subtitle">Spark Foundation</h4>
                <div class="st-resume-timeline-text">
                  <p>•	Collaborated with developers on dynamic websites using HTML, CSS, JavaScript, and PHP.<br>
•	Managed project timelines using tools like Google Calendar and solved technical issues for smooth deployment.
</p>
                </div>
              </div> <!-- st-resume-timeline -->
              <div class="st-height-b50 st-height-lg-b30"></div>
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Web Developer Intern</h3>
                <div class="st-resume-timeline-duration">(Remote) | Jul 2022 – Sep 2022</div>
                <h4 class="st-resume-timeline-subtitle">National Freelancing Training Program </h4>
                <div class="st-resume-timeline-text">
                  <p>•	Built and maintained responsive websites using core web technologies.<br>
•	Integrated Git for version control and contributed to team projects.
</p>
                </div>
              </div> <!-- st-resume-timeline -->
            </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="st-resume-wrap">
            ...
            <div class="st-resume-timeline-wrap">
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Bachelor of Engineering in Software Engineering</h3>
                <div class="st-resume-timeline-duration">2019 - 2023</div>
                <h4 class="st-resume-timeline-subtitle">Mehran University of Engineering & Technology Pakistan</h4>
                <div class="st-resume-timeline-text">
                  <p>•	<b>Relevant Coursework:</b> Web Development, Database Systems, Operating Systems</p>
                </div>
              </div> <!-- st-resume-timeline -->
              <div class="st-height-b50 st-height-lg-b30"></div>
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Certifications</h3>
                <!-- <div class="st-resume-timeline-duration">2010 - 2014</div>
                <h4 class="st-resume-timeline-subtitle">University of ABC</h4> -->
                <div class="st-resume-timeline-text">
                  <p>•	HTML, CSS, JavaScript – Coursera <br>
                  •	PHP- Mehran University of Engineering and Technology <br>
                  •	WordPress Development – National Freelancing Training Program <br>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="st-portfolio-single st-style1 st-lightgallery">
            <div class="st-portfolio-item">
              <a href="assets/img/portfolio/techiXpert.png" class="st-portfolio st-zoom st-lightbox-item">
                <div class="st-portfolio-img st-zoom-in">
                  <img src="assets/img/portfolio/tx.png" alt="portfolio">
                </div>
       ...
       <div class="col-lg-4 col-md-6">
          <div class="st-portfolio-single st-style1 st-lightgallery">
            <div class="st-portfolio-item">
              <a href="assets/img/portfolio/eng.png" class="st-portfolio st-zoom st-lightbox-item">
                <div class="st-portfolio-img st-zoom-in">
                  <img src="assets/img/portfolio/eng2.png" alt="portfolio">
                </div>
                <div class="st-portfolio-item-hover">
                  <i class="fas fa-plus-circle"></i>
                  <h5>Web Design</h5>
        ...
        <h1 >Comming Soon other portfolios</h1>
        <br>
        <!--  <div class="col-lg-4 col-md-6">
          <div class="st-portfolio-single st-style1 st-lightgallery">
            <div class="st-portfolio-item">
          ...
          <div class="st-contact-info-wrap">
            <div class="st-single-contact-info">
              ...
              <div class="st-single-info-details">
                <h4>Email</h4>
                <a href="https://mail.google.com/mail/?view=cm&fs=1&to=arkabdulrasheed19@gmail.com" target="_blank">arkabdulrasheed19@gmail.com</a>
            ...
            <div class="st-single-contact-info">
              ...
              <div class="st-single-info-details">
                <h4>Address</h4>
                <span>khayana shahbaz DHA 6<br>Karachi</span>
              </div>
            </div>
            <div class="st-social-info">
              <div class="st-social-text">Visite my LinkedIn profile and get connected</div>
